      ...
      <div className="flex bg-white rounded-2xl overflow-hidden shadow-2xl max-w-4xl w-full" onClick={(e) => e.stopPropagation()}>
        ...
        >
          ...
          <p className="text-center text-[16px]">Welcome back! Please sign in to continue</p>
           <button className="flex  justify-center gap-3 bg-[#F0F0F2] rounded-3xl hover:bg-gray-400/40 cursor-pointer py-2.5"><img src="google.png" alt="google png" className="size-5 " /><span className="text-[16px]">Google</span></button>
          {state === "register" && (
            <>
